...
export default function index() {
    ...
    return (
        ...
        <section className="container m-auto grid place-items-center pt-24 relative h-screen" id='About'>
            <div className='w-[80%] h-auto  bg-complementary mx-auto rounded-[40px] top-20 skew-x-[10deg] absolute z-10'>
                <div className="flex px-12 pt-8 items-center mb-[20px] invisible ">
                ...
                <div className=" text-[#818181] w-full pb-8 font-FiraCode text-[15.5px] invisible">
                    <div >
            ...
            <div className="w-[80%] h-auto bg-gradient-to-tr  from-primary from-[20%]  to-secondary mx-auto rounded-[40px] top-20 skew-x-[10deg] absolute z-10 animate-[about_5s_ease-in-out_infinite]">
